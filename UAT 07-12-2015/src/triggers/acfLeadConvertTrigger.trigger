/*====================================================
                Click Loan
========================================================*/
trigger acfLeadConvertTrigger on Lead (before update,after update) 
{
     ...
     {
         If(trigger.isBefore && !leadObj.isConverted && leadObj.acfIs_Bank_Statement_Submitted__c == true && leadObj.acfIs_Post_Login_Ques_Attempted__c == true && leadObj.acfIs_Identity_Document_Submitted__c == true){
